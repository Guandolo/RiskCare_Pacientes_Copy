...
const Auth = () => {
  ...
  const handleMagicLinkSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setEmailSent(true);
      toast.success('¡Revisa tu correo! Te hemos enviado un enlace de acceso seguro.');
    } catch (error: any) {
            ...
            <>
              <form onSubmit={handleMagicLinkSignIn} className="space-y-4">
                ...
                <Button
                  ...
                  disabled={emailLoading}
                >
                  {emailLoading ? 'Enviando enlace…' : 'Enviar enlace de acceso'}
                </Button>
              </form>
            ...
            <div className="text-center py-8 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Te hemos enviado un enlace de acceso seguro a <strong>{email}</strong>
                </p>
