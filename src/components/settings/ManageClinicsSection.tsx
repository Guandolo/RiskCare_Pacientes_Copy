...
export const ManageClinicsSection = () => {
    ...
    <div>
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold">Clínicas y IPS Registradas</h1>
            <p className="text-muted-foreground mt-1">Gestión de clínicas y administradores en la plataforma</p>
          </div>
          <Button onClick={() => {
            setEditingClinica(null);
            setClinicaData({
      ...
      {filteredClinicas.length === 0 ? (
        <Card className="p-12 text-center">
          ...
          <h3 className="text-lg font-semibold mb-2">
            {searchTerm ? "No se encontraron clínicas" : "No hay clínicas registradas"}
          </h3>
          <p className="text-muted-foreground mb-4">
            {searchTerm ? "Intenta con otro término de búsqueda" : "Crea la primera clínica para comenzar"}
          </p>
          {!searchTerm && (
